...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 bg-white flex-col">
        <div className="max-w-md">
          ...
          {/* App Name */}
          <h1 className="text-4xl font-bold text-gray-900 mb-4">SchoolHub</h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Welcome to SchoolHub</h2>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="space-y-2">
                {demoAccounts.map((account) => (
                  <div key={account.role} className="text-xs text-gray-600 bg-gray-50 p-2 rounded">
